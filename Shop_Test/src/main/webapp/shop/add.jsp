			...
			<div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
				<form action="add_pro.jsp" name="product" method="post" onsubmit="return checkProduct()" enctype="multipart/form-data">
					<div class="input-group mb-3 row">
						...
						<input type="file" class="form-control col-md-8" name="file" placeholder="상품이미지" required>
					</div>
					<div class="input-group mb-3 row">
						<label class="input-group-text col-md-4" id="">상품 코드</label>
						<input type="text" class="form-control col-md-8" name="productId" required>
					</div>
					<div class="input-group mb-3 row">
					...
					<div class="input-group mb-3 row">
						...
						<input type="text" class="form-control form-control-lg col-md-12 rounded-start" style="height: 100px;" name="description" required>
					</div>
					<div class="input-group mb-3 row">
