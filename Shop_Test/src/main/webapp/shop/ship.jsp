	...
	<div class="container shop p-5 mb-5" >
		<form action="order.jsp" name="DeliveryForm" method="post" >
			...
			<div class="input-group mb-3 row">
				...
				<input type="text" class="form-control col-md-8" name="deliveryDate" required>
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-4" id="">국가명</label>
				<input type="text" class="form-control col-md-8" name="nation" required>
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-4" id="">우편번호</label>
				<input type="text" class="form-control col-md-8" name="zipCode" required>
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-4" id="">주소</label>
				<input type="text" class="form-control col-md-8" name="address" required>
			</div>
			
			<div class="input-group mb-3 row">
				<label class="input-group-text col-md-4" id="">전화번호</label>
				<input type="text" class="form-control col-md-8" name="phone" required>
			</div>
